 ...
 */
public class DiffuseNormalSpecAOMap implements RenderUpdater {
    /**
...
//        "attribute vec3 binormal;" +
    ...
    private static final String fragmentShader = 
        ...
        "        finalColor += diffuseColor * NdotL * ambientOcc * gl_LightSource[0].diffuse.rgb;" +
        ...
        "        finalColor += diffuseColor * NdotL * ambientOcc * gl_LightSource[1].diffuse.rgb;" +
    ...
    public DiffuseNormalSpecAOMap(WorldManager worldManager) {
